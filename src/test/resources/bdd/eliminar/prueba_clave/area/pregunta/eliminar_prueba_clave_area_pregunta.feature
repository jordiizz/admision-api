Feature: Gestion de la estructura de las claves de prueba
  ...
  Scenario: Eliminar la relacion de una pregunta con un area dentro de una clave
    ...
    When elimino la pregunta con ID "50000000-0000-0000-0000-000000000001" del área "20000000-0000-0000-0000-000000000001" en la clave "40000000-0000-0000-0000-000000000001"
