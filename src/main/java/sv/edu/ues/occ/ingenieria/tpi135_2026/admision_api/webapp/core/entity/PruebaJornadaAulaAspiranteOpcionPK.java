...
public class PruebaJornadaAulaAspiranteOpcionPK implements Serializable {
    ...
    public PruebaJornadaAulaAspiranteOpcionPK(UUID idPrueba, UUID idJornada, String idAula, UUID idAspiranteOpcion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PruebaJornadaAulaAspiranteOpcionPK)) {
            return false;
        }
        PruebaJornadaAulaAspiranteOpcionPK other = (PruebaJornadaAulaAspiranteOpcionPK) obj;
